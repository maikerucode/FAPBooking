...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <br><br><br>
            <div style="max-width:700px; margin:auto" class="w3-center w3-text-light-grey">
                <h1>Scan the QR Code to Pay</h1>
                <img src="http://drive.google.com/uc?export=view&id=1MM3Z9k8gK7fCF0znJeZ4FxgnYpOZ4aGi" style="max-width: 300px">

                <form method="post" action="Booking">
                    <!--            if successful payment, redirect to bookingsuccess.jsp
                                then pass value to indicate confirmed payment-->
                    <br>
                    <input type="submit" name="action" value="Submit Payment" class="w3-btn w3-round w3-deep-orange"/>
                </form>
                <br><br>
            </div>
        </main>
